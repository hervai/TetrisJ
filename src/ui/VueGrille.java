...
public class VueGrille extends JPanel implements Observer {
	...
	private Image image, carre0, carre1, carre2, carre3, carre4, carre5,
			carre6, carre7, carrebc, gameover, pressstart;
	private Image[] fusee = new Image[9];
		...
		if (!j.getDebutjeu()) {
			...
			if (!j.getFinjeu()) {
				...
				if (!g.victoire()) {
					...
					// DECOLAGE FUSEE
					gr.drawImage(fusee[indexFusee], DECALAGE_GRILLE_X, 0, this);
				}
			}

		...
		try {
			...
			for (int i = 0; i < Grille.HAUTEUR_GRILLE; i++) {
				for (int j = 0; j < Grille.LARGEUR_GRILLE; j++) {
					...
					switch (valeurCase) {
					case 0:
						gr.drawImage(carre0, j * FenetreTetris.TAILLE_CARRE, i * FenetreTetris.TAILLE_CARRE, this);
						break;
					case 1:
						gr.drawImage(carre1, j * FenetreTetris.TAILLE_CARRE, i * FenetreTetris.TAILLE_CARRE, this);
						break;
					case 2:
						gr.drawImage(carre2, j * FenetreTetris.TAILLE_CARRE, i * FenetreTetris.TAILLE_CARRE, this);
						break;
					case 3:
						gr.drawImage(carre3, j * FenetreTetris.TAILLE_CARRE, i * FenetreTetris.TAILLE_CARRE, this);
						break;
					case 4:
						gr.drawImage(carre4, j * FenetreTetris.TAILLE_CARRE, i * FenetreTetris.TAILLE_CARRE, this);
						break;
					case 5:
						gr.drawImage(carre5, j * FenetreTetris.TAILLE_CARRE, i * FenetreTetris.TAILLE_CARRE, this);
						break;
					case 6:
						gr.drawImage(carre6, j * FenetreTetris.TAILLE_CARRE, i * FenetreTetris.TAILLE_CARRE, this);
						break;
					case 7:
